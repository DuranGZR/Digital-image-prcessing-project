...
def process_image(image_path, ground_truth_path=None):
    ...
    combined_mask = cv2.bitwise_or(refined_mask, otsu_threshold(preprocessed_image))
    combined_mask[combined_mask == 255] = 255
    combined_mask[combined_mask != 255] = 0
    combined_mask = cv2.threshold(combined_mask, 254, 255, cv2.THRESH_BINARY)[1]
    combined_mask[combined_mask != 255] = 0
...
# Girdi dosyası
image_path = '../Deneme2/data/img9.png'
